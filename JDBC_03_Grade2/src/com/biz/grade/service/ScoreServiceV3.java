...
public class ScoreServiceV3 {
	...
	public String inputStudent() {
		...
		while (true) {
			...
			if(stdDTO == null ) {
				System.out.println("학생정보에 학번이 없음");
	 ...
	 * Integer 클래스로 선언
	 * int형 return은 0~9까지의 숫자형들만 사용이 가능
	...
	public ScoreVO selectScore() {
		...
		if(strScore.equals("-Q:quit")) return null;
		return scoreVO;
	}
