...
public class ProductServiceV1 {
	...
	protected ProductDTO viewPDetail(String strPCode) {
		...
		/*
		 * 3항 연산자 조건식 ? true return : false return 
		 * 조건식이 참이면 method가 true를 return하는것과 같고
		 * 그렇지 않으면 false를 return하는 것과 같다
		 * 
		 * 변수에 조건에 따라 다른값을 채우고 싶을때 
		 * 변수 = 조건식 ? true : false s = a == 1 ? "참" : "거짓" 변수 a에
...
//		}
		 ...
		 * Integer.valueOf(strIPrice)에서 Exception 이 발생할 것이다.
