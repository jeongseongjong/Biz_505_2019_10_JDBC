...
public class AddrDaoImp extends AddrDao {
	...
	private AddrDTO rst_2_DTO(ResultSet rst) throws SQLException {
		...
		AddrDTO dto = AddrDTO.builder().A_id(rst.getLong("A_id")).A_name(rst.getString("A_name"))
				.A_tel(rst.getString("A_tel")).A_addr(rst.getString("A_addr")).A_chain(rst.getString("A_chain"))
				.build();
	...
	@Override
	public int delete(String A_name) {
